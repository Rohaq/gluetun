	...
	testCases := map[string]struct {
		...
		"different versions": {
			...
			hardcoded: models.AllServers{
				...
				SlickVPN:       models.Servers{Version: 1},
			...
			logged: []string{
				...
				"SlickVPN servers from file discarded because they have version 0 and hardcoded servers have version 1",
		...
		"same versions": {
			b: []byte(`{
				...
				"slickvpn": {"version": 1, "timestamp": 1},
			...
			persisted: models.AllServers{
				...
				SlickVPN:       models.Servers{Version: 1, Timestamp: 1},
